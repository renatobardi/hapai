export default {
  header: {
    ...
    auth: { signIn: 'Entrar com GitHub', signOut: 'Sair', signingIn: 'Entrando…' }
  },
  ...
  landing: {
    ...
    guardrails: {
      ...
      guards: {
        branchProtection: 'Bloqueia commits e pushes para main, master ou qualquer branch protegida.',
    ...
    analytics: {
      ...
      features: 'Timeline de 30 dias · Hooks mais bloqueadores · Distribuição de ferramentas · Breakdown por projeto · Tendência de taxa de negação',
    ...
    footer: {
      ...
      note: 'hapai v1.5.1 · Bash puro. Zero dependências. Segurança determinística.'
    }
  },
  docs: {
    nav: {
    ...
    sections: {
      ...
      guardrails: {
        ...
        guards: [
          'Branch Protection — Commits/pushes em branches protegidas (main, master)',
