...
pub trait ProjectRepository: Send + Sync {
    ...
    async fn find_by_slug(&self, workspace_id: Uuid, slug: &str) -> Result<Option<Project>, CoreError>;
    async fn list_by_workspace(&self, workspace_id: Uuid) -> Result<Vec<Project>, CoreError>;
